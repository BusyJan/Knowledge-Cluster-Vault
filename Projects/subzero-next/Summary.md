...
- **Antennas (ship bundle):** **v1 locked:** **all-black**, **tilt/knuckle** on all six SMAs; baseline `subzero-next/docs/ANTENNA-BOM-BASELINE.md` (MPNs TBD per port); prefs `PLACEMENT-INTENT.md`; vault **Notes** for dated decisions.
